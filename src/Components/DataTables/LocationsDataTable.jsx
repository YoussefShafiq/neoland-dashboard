...
export default function LocationsDataTable({ locations, loading, refetch }) {
    ...
    const handleAddLocation = async (e) => {
        ...
        try {
            ...
            // Add locationName only if it's not empty
    ...
    const filteredLocations = locations?.filter(location => {
        return (
            (filters.global === '' ||
                ...
                (location.locationName && location.locationName.toLowerCase().includes(filters.global.toLowerCase()))) &&
            (filters.arabic === '' ||
                location.locationDescAR.includes(filters.arabic)) &&
            (filters.english === '' ||
                location.locationDescEN.toLowerCase().includes(filters.english.toLowerCase())) &&
            (filters.name === '' ||
                (location.locationName && location.locationName.toLowerCase().includes(filters.name.toLowerCase())))
        );
    }) || [];
                            ...
                            <form onSubmit={handleAddLocation}>
                                ...
                                <div className="mb-6">
                                    ...
                                    <input
                                        ...
                                        onChange={handleFormChange}
                                        className="w-full px-3 py-2 border rounded-md"
                                        placeholder="Enter location name (e.g., Downtown, Suburb)"
                                    />
                                    <p className="text-xs text-gray-500 mt-1">
                                        Optional: A specific name for this location
                                    </p>
                                </div>
